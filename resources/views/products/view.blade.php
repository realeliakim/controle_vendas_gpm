                ...
                <div class="card-body" style="padding: 5%">
                    ...
                    <div class="form-group row" id="user_form">
                        <div class="col-md-6 mb-3">
                            ...
                            @enderror
                            <input id="section_value" type="hidden" class="form-control" value="{{ $product->section->id }}">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="form-group row mb-6">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="3" value="{{ $product->description }}" required autocomplete="" autofocus>{{ $product->description }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="stock" type="text" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ $product->stock }}" required autocomplete="" autofocus>
                            @error('stock')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
